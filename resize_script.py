...
input_folder = "/Volumes/Macintosh HD/Andrew/Work/PycharmProjects/Python/Primavera Website/Events/004_AnimalsOfFire/Photos/S3"  # Replace with your input folder path
output_folder = "/Volumes/Macintosh HD/Andrew/Work/PycharmProjects/Python/Primavera Website/Events/004_AnimalsOfFire/GalleryPhotos"  # Replace with your output folder path
