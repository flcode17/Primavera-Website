...
input_folder = "/Volumes/Macintosh HD/Andrew/Work/PycharmProjects/Python/Primavera Website/Events/006_Amore_More/Amore More - Primavera lll"  # Replace with your input folder path
output_folder = "/Volumes/Macintosh HD/Andrew/Work/PycharmProjects/Python/Primavera Website/Events/006_Amore_More/GalleryPhotos"  # Replace with your output folder path
