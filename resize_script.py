...
input_folder = "/Volumes/Macintosh HD/Andrew/Work/PycharmProjects/Python/Primavera Website/Events_New/005_ABetterWorld/Photos"  # Replace with your input folder path
output_folder = "/Volumes/Macintosh HD/Andrew/Work/PycharmProjects/Python/Primavera Website/Events_New/005_ABetterWorld/GalleryPhotos"  # Replace with your output folder path
scale_percentage = 50  #number, not percentage
